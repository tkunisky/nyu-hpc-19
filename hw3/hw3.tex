...
Then, as suggested in the problem, I perform the prefix sum calculation in parallel for each of these segments, and then correct with one final serial scan.
...
\noindent
The efficiency gradually improves with the number of threads, reaching an improvement of approximately 40\% over the serial or single-threaded version when four threads are used.
